    ...
    return(
        <>
            ...
            <div className="d-grid gap-1 d-md-flex mx-auto">
                <button id="unpublishbtn" className="btn-light btn-outline-dark wd-course-status-button" type="button" disabled={isUnpubBtnDisabled} onClick={() => changePublish("unpub")}><FaMinus /> Un-Publish</button>
                <button id="publishbtn" className="btn-light btn-outline-dark wd-course-status-button" type="button" disabled={isPubBtnDisabled} onClick={() => changePublish("pub")}><FaCheck /> Publish</button>
            </div>
            ...
            <div className="row wd-coming-up-todo-row">
                <Link to={`/Kanbas/Courses/${course?._id}/Grades`} className="wd-hyperlinks"><FaCalendar /> Grade CS5800 Quiz 3</Link>

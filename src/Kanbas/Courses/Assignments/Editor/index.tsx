...
function AssignmentEditor() {
    ...
    return (
        <div>
            <button type="button" className="wd-float-right btn btn-light btn-outline mt-1"><FaEllipsisV /></button>
            <span className="wd-float-right wd-tick mt-1" style={{paddingRight: "10px"}}><FaCheckCircle /> <b>Assignment Published</b></span>
